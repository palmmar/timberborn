...
export function NotNode({ id }: NodeProps) {
  ...
  return (
    <div className="relative border-2 border-slate-400 bg-slate-50 rounded-lg px-3 py-2 min-w-[90px] shadow-sm">
      <button
      ...
      >×</button>
      <div className="text-xs font-bold text-slate-700 text-center mb-2">NOT</div>
